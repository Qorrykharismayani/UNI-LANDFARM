        ...
        {[
          ...
          >
            ...
            <div>
              ...
              <h4 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none">{stat.value}</h4>
            </div>
          </div>
        ))}
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white dark:bg-slate-900/60 p-6 rounded-3xl border border-slate-200/60 dark:border-slate-800/80 shadow-sm flex flex-col hover:border-brand-blue/10 transition-all duration-300">
            ...
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xs font-black text-slate-900 dark:text-white tracking-tight uppercase">Proyek Terbaru</h3>
              <button
            ...
            {userProjects.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center flex-1 py-12">
                ...
                <h3 className="text-sm font-black text-slate-900 dark:text-white mb-1 tracking-tight">Belum ada proyek</h3>
                <p className="text-slate-400 dark:text-slate-500 text-[10px] font-medium mb-4">Buat landing page pertama Anda untuk memulai.</p>
                <button
                  onClick={() => setSubView('templates')}
                  className="px-6 py-2.5 bg-[#0F172A] dark:bg-white text-white dark:text-[#0F172A] rounded-xl font-black text-[9px] uppercase tracking-widest hover:scale-105 transition-all shadow-md flex items-center gap-1.5"
                >
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-brand-blue to-purple-600 rounded-3xl p-5 text-white shadow-lg overflow-hidden relative group border border-white/10">
            ...
            <button
              ...
              className="w-full py-2 bg-white text-brand-blue rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-blue-50 transition-all shadow-md flex items-center justify-center gap-2"
            >
