    ...
    <div className="max-w-6xl mx-auto relative z-10">
      <div className="grid md:grid-cols-4 gap-12 mb-8">
        <div className="col-span-1 md:col-span-1">
          <div className="h-[82px] flex items-center cursor-pointer group" onClick={() => setView('home')}>
        ...
        <div>
          <h4 className="font-black text-slate-900 dark:text-white mb-8 uppercase text-sm tracking-widest">Platform</h4>
          <ul className="space-y-4 text-lg text-slate-500 dark:text-slate-400 font-medium">
        ...
        <div>
          <h4 className="font-black text-slate-900 dark:text-white mb-8 uppercase text-sm tracking-widest">Sumber Daya</h4>
          <ul className="space-y-4 text-lg text-slate-500 dark:text-slate-400 font-medium">
        ...
        <div>
          <h4 className="font-black text-slate-900 dark:text-white mb-8 uppercase text-sm tracking-widest">Legal</h4>
          <ul className="space-y-4 text-lg text-slate-500 dark:text-slate-400 font-medium">
      ...
      <div className="pt-10 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-8 text-sm text-slate-400 dark:text-slate-500 font-black uppercase tracking-widest">
