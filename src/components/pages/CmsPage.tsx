          ...
          <div className="md:col-span-7 bg-white dark:bg-slate-900 rounded-[24px] p-6 border border-slate-100 dark:border-slate-800 shadow-premium flex flex-col justify-between space-y-6">
            ...
            {!isGenerating && (
              <button
                ...
                className="w-full py-3.5 bg-gradient-to-r from-brand-blue to-purple-650 hover:brightness-110 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-md transition-all active:scale-[0.98] cursor-pointer border-none"
              >
