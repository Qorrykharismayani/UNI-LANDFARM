    ...
    <div className="max-w-6xl mx-auto space-y-8 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-brand-blue text-white rounded-xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-md flex items-center justify-center gap-1.5 cursor-pointer shrink-0"
        >
      ...
      {filteredProjects.length > 0 ? (
            ...
            >
              ...
              <div className="space-y-3 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="text-lg font-black text-slate-900 dark:text-white truncate tracking-tight uppercase">{project.name || 'Tanpa Nama'}</h4>
                </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-slate-900/40 rounded-3xl border border-slate-200/60 dark:border-slate-800/80 shadow-sm">
          ...
          <h3 className="text-xl font-black text-slate-900 dark:text-white mb-1 tracking-tight">Tidak Ada Proyek Ditemukan</h3>
          <p className="text-slate-400 dark:text-slate-500 text-base font-medium max-w-xs text-center mb-4">
